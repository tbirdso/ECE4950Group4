...
MODEL           = custom_pwm
MODULES         = custom_pwm_capi.c custom_pwm_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = custom_pwm.mk
...
MODELLIB                  = custom_pwmlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = custom_pwm_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\custom_pwm_slrt_rtw
