...
#ifndef RTW_HEADER_move_from_strain_h_
#define RTW_HEADER_move_from_strain_h_
#include <stddef.h>
#include <string.h>
#include <float.h>
#include <math.h>
#include "rtw_modelmap.h"
#ifndef move_from_strain_COMMON_INCLUDES_
# define move_from_strain_COMMON_INCLUDES_
...
#include "xpcimports.h"
#endif                                 /* move_from_strain_COMMON_INCLUDES_ */

#include "move_from_strain_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_move_from_strain       RT_MODEL_move_from_strain_T

/* Definition for use in the target main file */
#define move_from_strain_rtModel       RT_MODEL_move_from_strain_T
...
#define rtB                            move_from_strain_B
#define BlockIO                        B_move_from_strain_T
#define rtP                            move_from_strain_P
#define Parameters                     P_move_from_strain_T
#define rtDWork                        move_from_strain_DW
#define D_Work                         DW_move_from_strain_T

/* Parameters (auto storage) */
struct P_move_from_strain_T_ {
  real_T Amplitude_Value;              /* Expression: 5
                                        * Referenced by: '<Root>/Amplitude'
                                        */
  real_T PD_Value;                     /* Expression: 0
...
struct tag_RTM_move_from_strain_T {
  const char_T *path;
...
extern P_move_from_strain_T move_from_strain_P;

/* Block signals (auto storage) */
extern B_move_from_strain_T move_from_strain_B;

/* Block states (auto storage) */
extern DW_move_from_strain_T move_from_strain_DW;

/*====================*
 * External functions *
 *====================*/
extern move_from_strain_rtModel *move_from_strain(void);
...
extern const rtwCAPI_ModelMappingStaticInfo*
  move_from_strain_GetCAPIStaticMap(void);

/* Real-time Model object */
extern RT_MODEL_move_from_strain_T *const move_from_strain_M;
