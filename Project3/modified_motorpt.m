...
pt(17).blockname = 'Logic Block/Position Iterator/Store_Index';
pt(17).paramname = 'InitialValue';
pt(17).class     = 'scalar';
pt(17).nrows     = 1;
pt(17).ncols     = 1;
...
pt(17).symbol     = 'modified_motor_P.Store_Index_InitialValue';
pt(17).baseaddr   = '&modified_motor_P.Store_Index_InitialValue';
pt(17).dtname     = 'real_T';
...
pt(19).blockname = 'motor_subsystem/Motor Selector/Constant';
...
pt(19).symbol     = 'modified_motor_P.Constant_Value';
pt(19).baseaddr   = '&modified_motor_P.Constant_Value';
pt(19).dtname     = 'real_T';



  
pt(20).blockname = 'motor_subsystem/Motor Selector/Gate1';
...
pt(20).symbol     = 'modified_motor_P.Gate1_Threshold';
pt(20).baseaddr   = '&modified_motor_P.Gate1_Threshold';
pt(20).dtname     = 'real_T';



  
pt(21).blockname = 'motor_subsystem/Motor Selector/Gate2';
...
pt(21).symbol     = 'modified_motor_P.Gate2_Threshold';
pt(21).baseaddr   = '&modified_motor_P.Gate2_Threshold';
pt(21).dtname     = 'real_T';



  
pt(22).blockname = 'motor_subsystem/Real motor/Saturation';
...
pt(22).symbol     = 'modified_motor_P.Saturation_UpperSat_a';
pt(22).baseaddr   = '&modified_motor_P.Saturation_UpperSat_a';
pt(22).dtname     = 'real_T';



  
pt(23).blockname = 'motor_subsystem/Real motor/Saturation';
...
pt(23).symbol     = 'modified_motor_P.Saturation_LowerSat_d';
pt(23).baseaddr   = '&modified_motor_P.Saturation_LowerSat_d';
pt(23).dtname     = 'real_T';



  
pt(24).blockname = 'motor_subsystem/Real motor/Q4 DA ';
pt(24).paramname = 'P1';
pt(24).class     = 'scalar';
pt(24).nrows     = 1;
pt(24).ncols     = 1;
...
pt(24).symbol     = 'modified_motor_P.Q4DA_P1';
pt(24).baseaddr   = '&modified_motor_P.Q4DA_P1';
pt(24).dtname     = 'real_T';



  
pt(25).blockname = 'motor_subsystem/Real motor/Q4 DA ';
pt(25).paramname = 'P2';
pt(25).class     = 'scalar';
pt(25).nrows     = 1;
pt(25).ncols     = 1;
...
pt(25).symbol     = 'modified_motor_P.Q4DA_P2';
pt(25).baseaddr   = '&modified_motor_P.Q4DA_P2';
pt(25).dtname     = 'real_T';
...
pt(26).symbol     = 'modified_motor_P.Q4DA_P3';
pt(26).baseaddr   = '&modified_motor_P.Q4DA_P3';
pt(26).dtname     = 'real_T';
...
pt(27).symbol     = 'modified_motor_P.Q4DA_P4';
pt(27).baseaddr   = '&modified_motor_P.Q4DA_P4';
pt(27).dtname     = 'real_T';
...
pt(28).symbol     = 'modified_motor_P.Q4DA_P5';
pt(28).baseaddr   = '&modified_motor_P.Q4DA_P5';
pt(28).dtname     = 'real_T';
...
pt(29).symbol     = 'modified_motor_P.Q4DA_P6';
pt(29).baseaddr   = '&modified_motor_P.Q4DA_P6';
pt(29).dtname     = 'real_T';
...
pt(30).symbol     = 'modified_motor_P.Q4DA_P7';
pt(30).baseaddr   = '&modified_motor_P.Q4DA_P7';
pt(30).dtname     = 'real_T';
...
pt(31).symbol     = 'modified_motor_P.Q4DA_P8';
pt(31).baseaddr   = '&modified_motor_P.Q4DA_P8';
pt(31).dtname     = 'real_T';
...
pt(32).symbol     = 'modified_motor_P.Q4DA_P9';
pt(32).baseaddr   = '&modified_motor_P.Q4DA_P9';
pt(32).dtname     = 'real_T';



  
pt(33).blockname = 'motor_subsystem/Real motor/Q4 Enc ';
pt(33).paramname = 'P1';
pt(33).class     = 'scalar';
pt(33).nrows     = 1;
pt(33).ncols     = 1;
...
pt(33).symbol     = 'modified_motor_P.Q4Enc_P1';
pt(33).baseaddr   = '&modified_motor_P.Q4Enc_P1';
pt(33).dtname     = 'real_T';



  
pt(34).blockname = 'motor_subsystem/Real motor/Q4 Enc ';
pt(34).paramname = 'P2';
pt(34).class     = 'scalar';
pt(34).nrows     = 1;
pt(34).ncols     = 1;
...
pt(34).symbol     = 'modified_motor_P.Q4Enc_P2';
pt(34).baseaddr   = '&modified_motor_P.Q4Enc_P2';
pt(34).dtname     = 'real_T';
...
pt(35).symbol     = 'modified_motor_P.Q4Enc_P3';
pt(35).baseaddr   = '&modified_motor_P.Q4Enc_P3';
pt(35).dtname     = 'real_T';
...
pt(36).symbol     = 'modified_motor_P.Q4Enc_P4';
pt(36).baseaddr   = '&modified_motor_P.Q4Enc_P4';
pt(36).dtname     = 'real_T';
...
pt(37).symbol     = 'modified_motor_P.Q4Enc_P5';
pt(37).baseaddr   = '&modified_motor_P.Q4Enc_P5';
pt(37).dtname     = 'real_T';
...
pt(38).symbol     = 'modified_motor_P.Q4Enc_P6';
pt(38).baseaddr   = '&modified_motor_P.Q4Enc_P6';
pt(38).dtname     = 'real_T';
...
pt(39).symbol     = 'modified_motor_P.Q4Enc_P7';
pt(39).baseaddr   = '&modified_motor_P.Q4Enc_P7';
pt(39).dtname     = 'real_T';
...
pt(40).symbol     = 'modified_motor_P.Q4Enc_P8';
pt(40).baseaddr   = '&modified_motor_P.Q4Enc_P8';
pt(40).dtname     = 'real_T';
...
pt(41).symbol     = 'modified_motor_P.Q4Enc_P9';
pt(41).baseaddr   = '&modified_motor_P.Q4Enc_P9';
pt(41).dtname     = 'real_T';
...
pt(42).symbol     = 'modified_motor_P.Q4Enc_P10';
pt(42).baseaddr   = '&modified_motor_P.Q4Enc_P10';
pt(42).dtname     = 'real_T';
...
pt(43).symbol     = 'modified_motor_P.Q4Enc_P11';
pt(43).baseaddr   = '&modified_motor_P.Q4Enc_P11';
pt(43).dtname     = 'real_T';
...
pt(44).symbol     = 'modified_motor_P.Q4Enc_P12';
pt(44).baseaddr   = '&modified_motor_P.Q4Enc_P12';
pt(44).dtname     = 'real_T';



  
pt(45).blockname = 'motor_subsystem/Simulated Motor/Integrator';
...
pt(45).symbol     = 'modified_motor_P.Integrator_IC_a';
pt(45).baseaddr   = '&modified_motor_P.Integrator_IC_a';
pt(45).dtname     = 'real_T';



  
pt(46).blockname = 'motor_subsystem/Simulated Motor/Integrator1';
pt(46).paramname = 'InitialCondition';
pt(46).class     = 'scalar';
pt(46).nrows     = 1;
pt(46).ncols     = 1;
...
pt(46).symbol     = 'modified_motor_P.Integrator1_IC';
pt(46).baseaddr   = '&modified_motor_P.Integrator1_IC';
pt(46).dtname     = 'real_T';



  
pt(47).blockname = 'motor_subsystem/Simulated Motor/Integrator2';
...
pt(47).symbol     = 'modified_motor_P.Integrator2_IC';
pt(47).baseaddr   = '&modified_motor_P.Integrator2_IC';
pt(47).dtname     = 'real_T';



  
pt(48).blockname = 'motor_subsystem/Switching Logic/Switch1';
...
pt(48).symbol     = 'modified_motor_P.Switch1_Threshold';
pt(48).baseaddr   = '&modified_motor_P.Switch1_Threshold';
pt(48).dtname     = 'real_T';
...
pt(49).symbol     = 'modified_motor_P.J';
pt(49).baseaddr   = '&modified_motor_P.J';
pt(49).dtname     = 'real_T';
...
pt(50).symbol     = 'modified_motor_P.Ke';
pt(50).baseaddr   = '&modified_motor_P.Ke';
pt(50).dtname     = 'real_T';
...
pt(51).symbol     = 'modified_motor_P.Kt';
pt(51).baseaddr   = '&modified_motor_P.Kt';
pt(51).dtname     = 'real_T';
...
pt(52).symbol     = 'modified_motor_P.L';
pt(52).baseaddr   = '&modified_motor_P.L';
pt(52).dtname     = 'real_T';
...
pt(53).symbol     = 'modified_motor_P.R';
pt(53).baseaddr   = '&modified_motor_P.R';
pt(53).dtname     = 'real_T';
...
pt(54).symbol     = 'modified_motor_P.b';
pt(54).baseaddr   = '&modified_motor_P.b';
pt(54).dtname     = 'real_T';
