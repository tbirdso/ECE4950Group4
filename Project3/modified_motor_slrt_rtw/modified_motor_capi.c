...
static const rtwCAPI_Signals rtBlockSignals[] = {
  ...
  { 1, 1, TARGET_STRING("Image Deconstructor/Fire Webcam"),
    TARGET_STRING(""), 0, 0, 0, 0, 1 },

  { 2, 2, TARGET_STRING("Image Deconstructor/Process Image"),
    TARGET_STRING("image_data_sig"), 0, 0, 1, 0, 1 },

  { 3, 0, TARGET_STRING("Image Deconstructor/Read Image"),
    TARGET_STRING(""), 0, 0, 0, 0, 1 },

  { 4, 3, TARGET_STRING("Logic Block/Generate Angles List"),
  ...
  { 18, 0, TARGET_STRING("Image Deconstructor/Clock/Sum"),
    TARGET_STRING(""), 0, 0, 0, 0, 1 },

  { 19, 0, TARGET_STRING("Image Deconstructor/Clock/Unit Delay"),
    TARGET_STRING(""), 0, 0, 0, 0, 1 },

  { 20, 0, TARGET_STRING("Logic Block/Clock/Sum"),
    TARGET_STRING(""), 0, 0, 0, 0, 1 },

  { 21, 0, TARGET_STRING("Logic Block/Clock/Unit Delay"),
    TARGET_STRING(""), 0, 0, 0, 0, 1 },

  { 22, 4, TARGET_STRING("Logic Block/Position Iterator/Iterator/p1"),
    TARGET_STRING("target_pos"), 0, 0, 0, 0, 3 },

  { 23, 4, TARGET_STRING("Logic Block/Position Iterator/Iterator/p2"),
    TARGET_STRING("iter_next_index"), 1, 0, 0, 0, 3 },

  { 24, 4, TARGET_STRING("Logic Block/Position Iterator/Iterator/p3"),
    TARGET_STRING(""), 2, 0, 0, 0, 3 },

  { 25, 5, TARGET_STRING("Logic Block/Position Iterator/Data Store Read"),
    TARGET_STRING("iter_cur_index"), 0, 0, 0, 0, 3 },

  { 26, 5, TARGET_STRING("Logic Block/Position Iterator/Data Store Read1"),
  ...
  { 30, 6, TARGET_STRING("motor_subsystem/Real motor/Convert to Rad"),
    TARGET_STRING(""), 0, 0, 0, 0, 0 },
...
static const rtwCAPI_BlockParameters rtBlockParameters[] = {
  ...
  { 51, TARGET_STRING("UI/Mode"),
    TARGET_STRING("Value"), 1, 0, 0 },

  { 52, TARGET_STRING("UI/Position"),
    TARGET_STRING("Value"), 0, 0, 0 },
  ...
  { 66, TARGET_STRING("Logic Block/Position Iterator/Store_Index1"),
    TARGET_STRING("InitialValue"), 0, 0, 0 },

  { 67, TARGET_STRING("motor_subsystem/Motor Selector/Constant"),
    TARGET_STRING("Value"), 0, 0, 0 },

  { 68, TARGET_STRING("motor_subsystem/Motor Selector/Gate1"),
    TARGET_STRING("Threshold"), 0, 0, 0 },

  { 69, TARGET_STRING("motor_subsystem/Motor Selector/Gate2"),
    TARGET_STRING("Threshold"), 0, 0, 0 },

  { 70, TARGET_STRING("motor_subsystem/Real motor/Saturation"),
    TARGET_STRING("UpperLimit"), 0, 0, 0 },

  { 71, TARGET_STRING("motor_subsystem/Real motor/Saturation"),
    TARGET_STRING("LowerLimit"), 0, 0, 0 },
  ...
  { 93, TARGET_STRING("motor_subsystem/Simulated Motor/Integrator"),
    TARGET_STRING("InitialCondition"), 0, 0, 0 },

  { 94, TARGET_STRING("motor_subsystem/Simulated Motor/Integrator1"),
    TARGET_STRING("InitialCondition"), 0, 0, 0 },

  { 95, TARGET_STRING("motor_subsystem/Simulated Motor/Integrator2"),
    TARGET_STRING("InitialCondition"), 0, 0, 0 },

  { 96, TARGET_STRING("motor_subsystem/Switching Logic/Switch1"),
    TARGET_STRING("Threshold"), 0, 0, 0 },
...
static const rtwCAPI_ModelParameters rtModelParameters[] = {
  ...
  { 97, TARGET_STRING("J"), 0, 0, 0 },

  { 98, TARGET_STRING("Ke"), 0, 0, 0 },

  { 99, TARGET_STRING("Kt"), 0, 0, 0 },

  { 100, TARGET_STRING("L"), 0, 0, 0 },

  { 101, TARGET_STRING("R"), 0, 0, 0 },

  { 102, TARGET_STRING("b"), 0, 0, 0 },
...
static void* rtDataAddrMap[] = {
  ...
  &modified_motor_B.image,             /* 1: Signal */
  &modified_motor_B.image_data[0],     /* 2: Signal */
  &modified_motor_B.ReadImage,         /* 3: Signal */
  &modified_motor_B.angles_vector[0],  /* 4: Signal */
  ...
  &modified_motor_B.Sig1,              /* 16: Signal */
  &modified_motor_B.Pos_Input,         /* 17: Signal */
  &modified_motor_B.Sum,               /* 18: Signal */
  &modified_motor_B.UnitDelay,         /* 19: Signal */
  &modified_motor_B.Sum_m,             /* 20: Signal */
  &modified_motor_B.UnitDelay_i,       /* 21: Signal */
  &modified_motor_B.target_pos_o,      /* 22: Signal */
  &modified_motor_B.next_index,        /* 23: Signal */
  &modified_motor_B.next_run,          /* 24: Signal */
  &modified_motor_B.iter_cur_index,    /* 25: Signal */
  &modified_motor_B.DataStoreRead1,    /* 26: Signal */
  &modified_motor_B.SwitchPosition,    /* 27: Signal */
  &modified_motor_B.SimulatedMotor,    /* 28: Signal */
  &modified_motor_B.RealMotor,         /* 29: Signal */
  &modified_motor_B.y,                 /* 30: Signal */
  ...
  &modified_motor_P.Mode_Value,        /* 51: Block Parameter */
  &modified_motor_P.Position_Value,    /* 52: Block Parameter */
  ...
  &modified_motor_P.Store_Index1_InitialValue,/* 66: Block Parameter */
  &modified_motor_P.Constant_Value_c,  /* 67: Block Parameter */
  &modified_motor_P.Gate1_Threshold,   /* 68: Block Parameter */
  &modified_motor_P.Gate2_Threshold,   /* 69: Block Parameter */
  &modified_motor_P.Saturation_UpperSat_a,/* 70: Block Parameter */
  &modified_motor_P.Saturation_LowerSat_d,/* 71: Block Parameter */
  &modified_motor_P.Q4DA_P1,           /* 72: Block Parameter */
  &modified_motor_P.Q4DA_P2,           /* 73: Block Parameter */
  &modified_motor_P.Q4DA_P3,           /* 74: Block Parameter */
  &modified_motor_P.Q4DA_P4,           /* 75: Block Parameter */
  &modified_motor_P.Q4DA_P5,           /* 76: Block Parameter */
  &modified_motor_P.Q4DA_P6,           /* 77: Block Parameter */
  &modified_motor_P.Q4DA_P7,           /* 78: Block Parameter */
  &modified_motor_P.Q4DA_P8,           /* 79: Block Parameter */
  &modified_motor_P.Q4DA_P9,           /* 80: Block Parameter */
  &modified_motor_P.Q4Enc_P1,          /* 81: Block Parameter */
  &modified_motor_P.Q4Enc_P2,          /* 82: Block Parameter */
  &modified_motor_P.Q4Enc_P3,          /* 83: Block Parameter */
  &modified_motor_P.Q4Enc_P4,          /* 84: Block Parameter */
  &modified_motor_P.Q4Enc_P5,          /* 85: Block Parameter */
  &modified_motor_P.Q4Enc_P6,          /* 86: Block Parameter */
  &modified_motor_P.Q4Enc_P7,          /* 87: Block Parameter */
  &modified_motor_P.Q4Enc_P8,          /* 88: Block Parameter */
  &modified_motor_P.Q4Enc_P9,          /* 89: Block Parameter */
  &modified_motor_P.Q4Enc_P10,         /* 90: Block Parameter */
  &modified_motor_P.Q4Enc_P11,         /* 91: Block Parameter */
  &modified_motor_P.Q4Enc_P12,         /* 92: Block Parameter */
  &modified_motor_P.Integrator_IC_a,   /* 93: Block Parameter */
  &modified_motor_P.Integrator1_IC,    /* 94: Block Parameter */
  &modified_motor_P.Integrator2_IC,    /* 95: Block Parameter */
  &modified_motor_P.Switch1_Threshold, /* 96: Block Parameter */
  &modified_motor_P.J,                 /* 97: Model Parameter */
  &modified_motor_P.Ke,                /* 98: Model Parameter */
  &modified_motor_P.Kt,                /* 99: Model Parameter */
  &modified_motor_P.L,                 /* 100: Model Parameter */
  &modified_motor_P.R,                 /* 101: Model Parameter */
  &modified_motor_P.b,                 /* 102: Model Parameter */
};
