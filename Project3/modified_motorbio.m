...
bio(9).dim=[1,1];
bio(9).sigWidth=1;
bio(9).sigAddress='&modified_motor_B.id_val';
bio(9).ndims=2;
bio(9).size=[];
...
bio(10).dim=[1,1];
bio(10).sigWidth=1;
bio(10).sigAddress='&modified_motor_B.DataTypeConversion1';
bio(10).ndims=2;
bio(10).size=[];
...
bio(11).dim=[1,1];
bio(11).sigWidth=1;
bio(11).sigAddress='&modified_motor_B.DataTypeConversion2';
bio(11).ndims=2;
bio(11).size=[];
bio(11).isStruct=false;

bio(12).blkName='motor_subsystem/Derivative';
bio(12).sigName='';
bio(12).portIdx=0;
bio(12).dim=[1,1];
bio(12).sigWidth=1;
bio(12).sigAddress='&modified_motor_B.Derivative';
bio(12).ndims=2;
bio(12).size=[];
bio(12).isStruct=false;

bio(13).blkName='motor_subsystem/Gain';
bio(13).sigName='';
bio(13).portIdx=0;
bio(13).dim=[1,1];
bio(13).sigWidth=1;
bio(13).sigAddress='&modified_motor_B.Gain';
bio(13).ndims=2;
bio(13).size=[];
bio(13).isStruct=false;

bio(14).blkName='motor_subsystem/KI';
bio(14).sigName='';
bio(14).portIdx=0;
bio(14).dim=[1,1];
bio(14).sigWidth=1;
bio(14).sigAddress='&modified_motor_B.KI';
bio(14).ndims=2;
bio(14).size=[];
bio(14).isStruct=false;

bio(15).blkName='motor_subsystem/Kd';
bio(15).sigName='';
bio(15).portIdx=0;
bio(15).dim=[1,1];
bio(15).sigWidth=1;
bio(15).sigAddress='&modified_motor_B.Kd';
bio(15).ndims=2;
bio(15).size=[];
bio(15).isStruct=false;

bio(16).blkName='motor_subsystem/Kp';
bio(16).sigName='';
bio(16).portIdx=0;
bio(16).dim=[1,1];
bio(16).sigWidth=1;
bio(16).sigAddress='&modified_motor_B.Kp';
bio(16).ndims=2;
bio(16).size=[];
bio(16).isStruct=false;

bio(17).blkName='motor_subsystem/Integrator';
bio(17).sigName='';
bio(17).portIdx=0;
bio(17).dim=[1,1];
bio(17).sigWidth=1;
bio(17).sigAddress='&modified_motor_B.Integrator';
bio(17).ndims=2;
bio(17).size=[];
bio(17).isStruct=false;

bio(18).blkName='motor_subsystem/Saturation';
bio(18).sigName='Voltage_Input';
bio(18).portIdx=0;
bio(18).dim=[1,1];
bio(18).sigWidth=1;
bio(18).sigAddress='&modified_motor_B.Voltage_Input';
bio(18).ndims=2;
bio(18).size=[];
bio(18).isStruct=false;

bio(19).blkName='motor_subsystem/Sum';
bio(19).sigName='Sig1';
bio(19).portIdx=0;
bio(19).dim=[1,1];
bio(19).sigWidth=1;
bio(19).sigAddress='&modified_motor_B.Sig1';
bio(19).ndims=2;
bio(19).size=[];
bio(19).isStruct=false;

bio(20).blkName='motor_subsystem/Sum1';
bio(20).sigName='Pos_Input';
bio(20).portIdx=0;
bio(20).dim=[1,1];
bio(20).sigWidth=1;
bio(20).sigAddress='&modified_motor_B.Pos_Input';
bio(20).ndims=2;
bio(20).size=[];
bio(20).isStruct=false;

bio(21).blkName='Image Deconstructor/Clock/Sum';
bio(21).sigName='';
bio(21).portIdx=0;
bio(21).dim=[1,1];
bio(21).sigWidth=1;
bio(21).sigAddress='&modified_motor_B.Sum';
bio(21).ndims=2;
bio(21).size=[];
bio(21).isStruct=false;

bio(22).blkName='Image Deconstructor/Clock/Unit Delay';
bio(22).sigName='';
bio(22).portIdx=0;
bio(22).dim=[1,1];
bio(22).sigWidth=1;
bio(22).sigAddress='&modified_motor_B.UnitDelay';
bio(22).ndims=2;
bio(22).size=[];
bio(22).isStruct=false;

bio(23).blkName='Logic Block/Clock/Sum';
bio(23).sigName='';
bio(23).portIdx=0;
bio(23).dim=[1,1];
bio(23).sigWidth=1;
bio(23).sigAddress='&modified_motor_B.Sum_m';
bio(23).ndims=2;
bio(23).size=[];
bio(23).isStruct=false;

bio(24).blkName='Logic Block/Clock/Unit Delay';
bio(24).sigName='';
bio(24).portIdx=0;
bio(24).dim=[1,1];
bio(24).sigWidth=1;
bio(24).sigAddress='&modified_motor_B.UnitDelay_i';
bio(24).ndims=2;
bio(24).size=[];
bio(24).isStruct=false;

bio(25).blkName='Logic Block/Position Iterator/Iterator/p1';
bio(25).sigName='target_pos';
bio(25).portIdx=0;
bio(25).dim=[1,1];
bio(25).sigWidth=1;
bio(25).sigAddress='&modified_motor_B.target_pos_o';
bio(25).ndims=2;
bio(25).size=[];
bio(25).isStruct=false;

bio(26).blkName='Logic Block/Position Iterator/Iterator/p2';
bio(26).sigName='iter_next_index';
bio(26).portIdx=1;
bio(26).dim=[1,1];
bio(26).sigWidth=1;
bio(26).sigAddress='&modified_motor_B.next_index';
bio(26).ndims=2;
bio(26).size=[];
bio(26).isStruct=false;

bio(27).blkName='Logic Block/Position Iterator/Data Store Read';
bio(27).sigName='iter_cur_index';
bio(27).portIdx=0;
bio(27).dim=[1,1];
bio(27).sigWidth=1;
bio(27).sigAddress='&modified_motor_B.iter_cur_index';
bio(27).ndims=2;
bio(27).size=[];
...
bio(31).dim=[1,1];
bio(31).sigWidth=1;
bio(31).sigAddress='&modified_motor_B.y_f';
bio(31).ndims=2;
bio(31).size=[];
