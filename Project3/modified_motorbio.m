...
bio(2).blkName='Image Deconstructor/Fire Webcam';
bio(2).sigName='';
bio(2).portIdx=0;
bio(2).dim=[1,1];
bio(2).sigWidth=1;
bio(2).sigAddress='&modified_motor_B.image';
bio(2).ndims=2;
bio(2).size=[];
bio(2).isStruct=false;

bio(3).blkName='Image Deconstructor/Process Image';
bio(3).sigName='image_data_sig';
bio(3).portIdx=0;
bio(3).dim=[100,4];
bio(3).sigWidth=400;
bio(3).sigAddress='&modified_motor_B.image_data[0]';
bio(3).ndims=2;
bio(3).size=[];
bio(3).isStruct=false;

bio(4).blkName='Image Deconstructor/Read Image';
bio(4).sigName='';
bio(4).portIdx=0;
bio(4).dim=[1,1];
bio(4).sigWidth=1;
bio(4).sigAddress='&modified_motor_B.ReadImage';
bio(4).ndims=2;
bio(4).size=[];
bio(4).isStruct=false;

bio(5).blkName='Logic Block/Generate Angles List';
bio(5).sigName='';
bio(5).portIdx=0;
bio(5).dim=[100,1];
bio(5).sigWidth=100;
bio(5).sigAddress='&modified_motor_B.angles_vector[0]';
bio(5).ndims=2;
bio(5).size=[];
...
bio(17).dim=[1,1];
bio(17).sigWidth=1;
bio(17).sigAddress='&modified_motor_B.Sig1';
bio(17).ndims=2;
bio(17).size=[];
...
bio(19).blkName='Image Deconstructor/Clock/Sum';
bio(19).sigName='';
bio(19).portIdx=0;
bio(19).dim=[1,1];
bio(19).sigWidth=1;
...
bio(20).blkName='Image Deconstructor/Clock/Unit Delay';
bio(20).sigName='';
bio(20).portIdx=0;
bio(20).dim=[1,1];
bio(20).sigWidth=1;
...
bio(21).blkName='Logic Block/Clock/Sum';
bio(21).sigName='';
bio(21).portIdx=0;
bio(21).dim=[1,1];
bio(21).sigWidth=1;
bio(21).sigAddress='&modified_motor_B.Sum_m';
bio(21).ndims=2;
bio(21).size=[];
bio(21).isStruct=false;

bio(22).blkName='Logic Block/Clock/Unit Delay';
bio(22).sigName='';
bio(22).portIdx=0;
bio(22).dim=[1,1];
bio(22).sigWidth=1;
bio(22).sigAddress='&modified_motor_B.UnitDelay_i';
bio(22).ndims=2;
bio(22).size=[];
bio(22).isStruct=false;

bio(23).blkName='Logic Block/Position Iterator/Iterator/p1';
bio(23).sigName='target_pos';
bio(23).portIdx=0;
bio(23).dim=[1,1];
bio(23).sigWidth=1;
bio(23).sigAddress='&modified_motor_B.target_pos_o';
bio(23).ndims=2;
bio(23).size=[];
bio(23).isStruct=false;

bio(24).blkName='Logic Block/Position Iterator/Iterator/p2';
bio(24).sigName='iter_next_index';
bio(24).portIdx=1;
bio(24).dim=[1,1];
bio(24).sigWidth=1;
bio(24).sigAddress='&modified_motor_B.next_index';
bio(24).ndims=2;
bio(24).size=[];
bio(24).isStruct=false;

bio(25).blkName='Logic Block/Position Iterator/Iterator/p3';
bio(25).sigName='';
bio(25).portIdx=2;
bio(25).dim=[1,1];
bio(25).sigWidth=1;
bio(25).sigAddress='&modified_motor_B.next_run';
bio(25).ndims=2;
bio(25).size=[];
bio(25).isStruct=false;

bio(26).blkName='Logic Block/Position Iterator/Data Store Read';
bio(26).sigName='iter_cur_index';
bio(26).portIdx=0;
bio(26).dim=[1,1];
bio(26).sigWidth=1;
bio(26).sigAddress='&modified_motor_B.iter_cur_index';
bio(26).ndims=2;
bio(26).size=[];
bio(26).isStruct=false;

bio(27).blkName='Logic Block/Position Iterator/Data Store Read1';
bio(27).sigName='';
bio(27).portIdx=0;
bio(27).dim=[1,1];
bio(27).sigWidth=1;
bio(27).sigAddress='&modified_motor_B.DataStoreRead1';
bio(27).ndims=2;
bio(27).size=[];
