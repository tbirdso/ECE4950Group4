...
% Last Modified by GUIDE v2.5 10-Mar-2020 22:19:41
...
% --- Executes on button press in toggle_run.
function toggle_run_Callback(hObject, eventdata, handles)
% hObject    handle to toggle_run (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of toggle_run
...
% --- Executes on selection change in menu_shape.
function menu_shape_Callback(hObject, eventdata, handles)
% hObject    handle to menu_shape (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
shape_contents = cellstr(get(hObject,'String'));
shape = num2str(shape_contents{get(hObject,'Value')});
switch shape
    case 'Square'
        shape_choice = 1;
    case 'Circle'
...
% --- Executes during object creation, after setting all properties.
function menu_shape_CreateFcn(hObject, eventdata, handles)
% hObject    handle to menu_shape (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in push_everysticker.
function push_everysticker_Callback(hObject, eventdata, handles)
% hObject    handle to push_everysticker (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in push_everycolor.
function push_everycolor_Callback(hObject, eventdata, handles)
% hObject    handle to push_everycolor (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
every_color = get(hObject,'Value');
if every_color == 1
    every_sticker = 0;
    specific_sticker = 0;
end
...
% --- Executes on button press in push_specificsticker.
function push_specificsticker_Callback(hObject, eventdata, handles)
% hObject    handle to push_specificsticker (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
specific_sticker = 1;
if specific_sticker == 1
    every_color = 0;
    every_sticker = 0;
end
